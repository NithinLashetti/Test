...
public class SquidexService {
	...
	public ResponseEntity<?> getDprofile1(String profRef) {
		...
		resp.setId(squidexBaseResponse.getId());
		...
		resp.setContactDetails(it.get("contactDetails"));
		resp.setTheme1((String) it.get("theme1"));
		resp.setTheme2((String) it.get("theme2"));
		resp.setDefaulLang((String) it.get("defaultLanguage"));
		resp.setFavicon(it.get("favIcon"));
		resp.setDisplayName((String) it.get("DisplayName"));
		resp.setLinks((List<Map<String, String>>) it.get("links"));
		resp.setCurrency((String) it.get("currency"));
	...
	public ResponseEntity<?> getWebHubClientData(String name) {
		...
		details.setName(detail.get("name"));
		details.setPrefix(detail.get("Prefix"));
